...
def find_records():
    if request.method == 'POST':
        ...
        return render_template('index.html', persons=persons, keyword=keyword, show_result=True, developer_name='Ruslan')
    else:
        return render_template('index.html', show_result=False, developer_name='Ruslan')  
...
def add_record():
    if request.method == 'POST':
        ...
        if name is None or name.strip() == '':
            ...
            show_result=False, action_name='save', developer_name='Ruslan')
        elif name.isdecimal():
            return render_template('add-update.html', not_valid=True, message='Invalid input: Name can not be number.', 
            show_result=False, action_name='save', developer_name='Ruslan')                      
        ...
        return render_template('add-update.html', show_result=True, result=result, 
        not_valid=False, action_name='save', developer_name='Ruslan')
    else:
...
def update_record():
    if request.method == 'POST':
        ...
        if name is None or name.strip() == '':
            return render_template('add-update.html', not_valid=True, message='Invalid input: Name can not be empty.', 
            show_result=False, action_name='update', developer_name='Ruslan')
        elif name.isdecimal():
            return render_template('add-update.html', not_valid=True, message='Invalid input: Name can not be number.', 
            show_result=False, action_name='update', developer_name='Ruslan')                      
        ...
        return render_template('add-update.html', show_result=True, result=result, 
        not_valid=False, action_name='update', developer_name='Ruslan')
    else:
...
def delete_record():
    if request.method == 'POST':
        ...
        return render_template('delete.html', show_result=True, result=result, not_valid=False, developer_name='Ruslan')
    else:
        return render_template('delete.html', show_result=False, not_valid=False, developer_name='Ruslan')
